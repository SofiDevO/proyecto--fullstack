...
<div className="sepadaror">
 <h1 align="center">nuestro servicio</h1>

<p align="justify">¡Bienvenido a <span>CodeJourney!</span> Aquí, la educación se adapta a ti. Imagina un espacio donde puedes explorar un mundo de conocimiento a tu propio ritmo, sin restricciones.
