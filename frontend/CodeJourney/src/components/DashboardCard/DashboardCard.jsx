      ...
      <div className="dashboard-card">
        ...
        <div className="dashboard-card-container">
          ...
          <p className="text__content">
            ¡Bienvenido a Aquí, la educación se adapta a ti. Imagina un espacio
            donde puedes explorar un mundo de conocimiento a tu propio ritmo,
            sin restricciones. Con una amplia variedad de
          </p>
        </div>
      </div>
    </div>
